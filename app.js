...
// app.use(bodyParser.json()); // Добавляем поддержку парсинга JSON для AJAX

// // Маршруты для работы с флеш-картами
// const flashcardRoutes = require('./routes/flashcards');
// app.use('/api/flashcards', flashcardRoutes); // Маршруты API для CRUD операций
